...
path_dict = {
    ...
    "flower102": ["jpg", "data/oxford_flowers/split_zhou_OxfordFlowers.json"],
    "food101": ["images", "data/food-101/split_zhou_Food101.json"],
    "dtd": ["images", "data/dtd/split_zhou_DescribableTextures.json"],
    "pets": ["images", "data/oxford_pets/split_zhou_OxfordPets.json"],
    "sun397": ["SUN397", "data/sun397/split_zhou_SUN397.json"],
    "caltech101": ["101_ObjectCategories", "/mnt/c/Users/Lucas/Research/Datasets/caltech-101/split_zhou_Caltech101.json"],
    "ucf101": ["UCF-101-midframes", "data/ucf101/split_zhou_UCF101.json"],
    "cars": ["", "data/stanford_cars/split_zhou_StanfordCars.json"],
    "eurosat": ["2750", "data/eurosat/split_zhou_EuroSAT.json"]
}
